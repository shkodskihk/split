...
( function( $ ) {
  ...
  wp.customize( 'split_footer_background_color', function( value ) {
    value.bind( function( to ) {
  ...
  // Footer text color
  wp.customize( 'split_footer_textcolor', function( value ) {
    value.bind( function( to ) {
  ...
  // Footer text color
  wp.customize( 'split_footer_link_color', function( value ) {
    value.bind( function( to ) {
  ...
  // Secondary color
  wp.customize( 'split_secondary_color', function( value ) {
    value.bind( function( to ) {
  ...
  // Tertiary color
  wp.customize( 'split_tertiary_color', function( value ) {
    value.bind( function( to ) {
	...
	// Text color
	wp.customize( 'split_text_color', function( value ) {
		value.bind( function( to ) {
			$( 'body' ).css( { 'color': to } );
		} );
	} );
  ...
  // Links color
  wp.customize( 'split_link_color', function( value ) {
    value.bind( function( to ) {
      $( 'a' ).css( { 'color': to } );
  ...
  // Button Text color
  wp.customize( 'split_button_text_color', function( value ) {
    value.bind( function( to ) {
  ...
  wp.customize( 'split_button_background_color', function( value ) {
    value.bind( function( to ) {
